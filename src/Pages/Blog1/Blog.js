          ...
          <div className="blog">
            ...
            <div className="blog--text">
              <h1 style={{ color: dark ? "#fff" : "" }}>
                {value === "kg"
                  ? "Эмне үчүн Flutter үйрөнүшүңүз керек?"
                  : "\n" + "Why should you learn Flutter?"}
              </h1>
              <p style={{ color: dark ? "#fff" : "" }}>
                {value === "kg"
                  ? "Учурда интернет колдонуучулардын 90 пайыздан ашыгы\n" +
                    ...
                    "                                болуп, өзүңүздүн кыялдарыңызга жетиңиз!"
                  : "Currently, more than 90 percent of Internet users\n" +
